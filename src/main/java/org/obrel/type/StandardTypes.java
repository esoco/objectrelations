...
public class StandardTypes {
	 ...
	 * property depends on the application but it is recommended to use
	 * either a
	 ...
	 * updates of the relations in a relatable object, of a relation type,
	 * or of
	 ...
	 */
	public static final RelationType<Pair<Long, TimeUnit>> DURATION =
		newType();
	 ...
	 * reference or define their own relation type with a more specific
	 * datatype
	 * and set the meta-flag {@link MetaTypes#PARENT_ATTRIBUTE} on it. Code
	 * that
	 ...
	 * object structure. Applications can either use this type for the
	 * reference
