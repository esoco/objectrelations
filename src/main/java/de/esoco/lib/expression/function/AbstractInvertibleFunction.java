...
/********************************************************************
 * A function base class that also implements {@link InvertibleFunction}.
 *
 * @author eso
 */
public abstract class AbstractInvertibleFunction<I, O>
	extends AbstractFunction<I, O> implements InvertibleFunction<I, O>
{
	 ...
	 */
	public AbstractInvertibleFunction(String sToken)
	{
		super(sToken);
	}
}
