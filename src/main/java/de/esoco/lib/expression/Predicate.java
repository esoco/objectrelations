...
public interface Predicate<T>
	extends Function<T, Boolean>, java.util.function.Predicate<T> {
	...
	/**
	 * Re-defined from {@link Function#from(Function)} to return a new
	 * predicate
	...
	/**
	 * Returns a new predicate with a logical OR expression for this and
	 * another
