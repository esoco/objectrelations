...
public class JsonRelatedObjectTest {
	...
	private static final byte[] TEST_BYTE_ARRAY = new byte[] { 0x31, 0x32, 0x33, 0x34, 0x35 };
	private static final Integer[] TEST_INTEGER_ARRAY = new Integer[] { 1, 2, 3, 4, 5 };

	private static final List<Integer> TEST_LIST = Arrays.asList(1, 2, 3, 4);

	private static final JsonObject TEST_OBJECT = new JsonObject(t("k1", "v1"), t("k2", "v2"), t("k3", "v3"));
